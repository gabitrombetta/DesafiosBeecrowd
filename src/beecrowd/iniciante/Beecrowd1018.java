...
public class Beecrowd1018 {
    public static void main(String[] args) {
        ...
        int notasCem = valor / 100; // 5
        valor %= 100; // 76
        int notasCinquenta = valor / 50; // 1
        valor %= 50; // 26
        int notasVinte = valor / 20; // 1
        valor %= 20; // 6
        int notasDez = valor / 10; // 0
        valor %= 10; // 6
        int notasCinco = valor / 5; // 1
        valor %= 5; // 1
        int notasDois = valor / 2; // 0
        valor %= 2; // 1
        int notasUm = valor / 1; // 1
